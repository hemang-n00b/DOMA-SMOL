...
def evaluate_with_gpt4(question, generated_response, ideal_response):
    ...
    prompt = f"""
    Evaluate the following LLM-generated response on a Likert scale of 1-5 based on correctness, relevance, and fluency. Be a bit linient while scoring and give higher scores around 4.
