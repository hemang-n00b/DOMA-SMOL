...
from model_decider import model_decider_cache_sa, model_decider_sa_latency, model_decider_sa_confidence
...
def process_requests():
    global inference_in_progress, active_model, loaded_models
    ...
    while True:
        ...
        try:
            ...
            log_entry = {"model": model_name, "inf_time": inf_time,"cache_hits":cache_hits,"cache_hit_ratio":cache_h_ratio}
